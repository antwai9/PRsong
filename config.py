...
OWNER_NAME = getenv("OWNER_NAME", "x_U_S_A")
ALIVE_NAME = getenv("ALIVE_NAME", "Neyork")
BOT_USERNAME = getenv("BOT_USERNAME")
ASSISTANT_NAME = getenv("ASSISTANT_NAME")
GROUP_SUPPORT = getenv("GROUP_SUPPORT", "xU_S_A1")
UPDATES_CHANNEL = getenv("UPDATES_CHANNEL", "URLS_USA")
...
REPO_OWNER = getenv("REPO_OWNER", "x_U_S_A")
MY_HEART = getenv("MY_HEART", "URLS_USA")
BOT_UPDATE = getenv("BOT_UPDATE", "URLS_USA")
MY_BRO = getenv("MY_BRO", "x_U_S_A")
